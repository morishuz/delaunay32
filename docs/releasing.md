...
example `v0.3.0`. A release tag identifies an immutable release commit; create
...
8. Create and push an annotated tag:
   ...
   git tag -a v0.3.0 -m "Delaunay32 0.3.0"
