...
```cmake
project(delaunay32 VERSION 0.2.0 LANGUAGES CXX)
```
...
example `v0.2.0`. A release tag identifies an immutable release commit; create
...
8. Create and push an annotated tag:
   ...
   git tag -a v0.2.0 -m "Delaunay32 0.2.0"
